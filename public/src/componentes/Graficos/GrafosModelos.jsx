 ...
 const handleFiltroFechaChange = (valor) => {
  ...
  return (
   ...
   <Select placeholder="Fechas" className='fechas-grafos' onChange={handleFiltroFechaChange} defaultValue={filtroFecha}>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/movilizacion/grafo_modelo-Atributos%20de%20Personalidad-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/movilizacion/grafo_modelo-Atributos%20de%20Politicos-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
